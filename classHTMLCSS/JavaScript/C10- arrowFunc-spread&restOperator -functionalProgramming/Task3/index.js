...
// const filterfn = (item, i) => {
//   console.log("arr filter >>", item, i);
//   if (item % 2 === 0) return true;
// };

// const filterArr = data.filter(filterfn);
...
// const summation1 = (numbers) => {
//   const sum = numbers.reduce((accumulative, item) => {
//       var add = accumulative + item ;
//       return add;
//   }, 0);
//   return sum;
// };

// const summation1 = numbers => numbers.reduce((accumulative, item) => accumulative + item,0);
